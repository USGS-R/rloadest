...
BrushyQ <- renameNWISColumns(BrushyQ)
# Rename the Flow column, must be done manually as renameNWISColumns
# appends _Inst
names(BrushyQ)[names(BrusyQ) == "Flow_Inst"] <- "Flow"
...
79 p., https://dx.doi.org/10.3133/sir20145141.

\bibitem{Lo}
Landers, M.N., Ankcorn, P.D., and McFadden, K.W., 2007, Watershed effects on streamflow quantity and quality in six watersheds of Gwinnett Count, Georgia: U.S. Geological Survey Scientific Investigations Report 2007-5132, 62 p., Web-only publication at https://pubs.usgs.gov/sir/2007/5132/
